...
from base_models.inception import Inception3
from base_models.resnet import resnet50, resnet101, resnet34, resnet18, ResNet101_Weights, ResNet50_Weights, ResNet34_Weights, ResNet18_Weights
...
def resnet101_model(args: Experiment, weight_n: int = 1):
    ## List of kwargs that are used in the inception model
    # n_attributes, # args.n_attributes
    # expand_dim, # args.expand_dim
    # aux_logits=True, # True
...
def resnet34_model(args: Experiment, weight_n: int = 1):
    assert args.use_aux == False
...
def resnet18_model(args: Experiment, weight_n: int = 1):
    assert args.use_aux == False
